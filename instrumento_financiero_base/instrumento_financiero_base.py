"""
Descripción:   Clase base con metodos generales para practicmaente cualquier instrumento financiero
...
class FinancialInstrument:
    def __init__(self, expire_date:pd.Timestamp, emition_date:pd.Timestamp, calendar_convention:str = 'Actual/360'):
